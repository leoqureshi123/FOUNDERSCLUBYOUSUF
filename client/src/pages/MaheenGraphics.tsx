...
import maheenCv from "../assets/Maheen Javed Resume.pdf"
...
const skills: SkillItem[] = [
  ...
  { id: "4", name: "Computer Skills" },
]

export function MaheePortfolioCard() {
    ...
    <main className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 w-full">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-4 text-balance">Maheen Javed</h1>
                ...
                <p className="text-lg text-foreground/90 leading-relaxed text-balance">
                  Graphic Designer with 1+ year of experience in the management of complete design process, from
                  conceptualization to delivery. Skilled with Adobe Creative Suite (Illustrator, Photoshop). Experienced in
                  handling simultaneous creative design projects, concept creation, and graphic design.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  href="https://www.behance.net/maheenjaved3"
                  target="_blank"
      ...
      <section id="contact" className="px-4 md:px-8 py-20 bg-gradient-to-r from-primary/10 to-accent/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm text-muted-foreground mt-6">📧 maheenj39331@gmail.com • 📱 +923365639331 • 📍 Rawalpindi, Pakistan</p>
        </div>
      </section>
    </main>
  )

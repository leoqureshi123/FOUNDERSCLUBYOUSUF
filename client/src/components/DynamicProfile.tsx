...
export default function DynamicProfile({ profileData }: DynamicProfileProps) {
  ...
  const renderSkills = () => {
    if (profileData.isSkillCategory) {
      const skillCategories = profileData.skills as SkillCategory[];
      return (
      ...
      const skills = profileData.skills as Skill[];
      return (
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 w-full">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-4 text-balance">{profileData.name}</h1>
                <p className="text-2xl md:text-3xl text-primary font-semibold mb-6">{profileData.title}</p>
